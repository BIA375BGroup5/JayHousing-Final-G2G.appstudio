...
const cacheName = 'JayHousing_Final-2021-05-02 17:44:59.347552'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'JayHousing_Final'.length) === 'JayHousing_Final') {
